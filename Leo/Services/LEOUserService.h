...
- (void)updateUser:(Guardian *)guardian
...
- (void)createPatients:(NSArray *)patients
        withCompletion:(void (^)(NSArray<Patient *> *responsePatients, NSError *error))completionBlock;

- (void)createPatient:(Patient *)newPatient
       withCompletion:(void (^)(Patient * patient, NSError *error))completionBlock;

- (NSURLSessionTask *)getUserWithID:(NSString *)userID
                     withCompletion:(void (^)(Guardian *guardian, NSError *error))completionBlock;
...
- (void)postAvatarsForUsers:(NSArray <User *> *)users
             withCompletion:(void (^)(BOOL success, NSError *error))completionBlock;

- (void)postAvatarForUser:(User *)user
           withCompletion:(void (^)(BOOL success, NSError *error))completionBlock;


- (void)updateAvatarImagesForUsers:(NSArray <User *> *)responseUsers
                    withLocalUsers:(NSArray <User *> *)localUsers;

- (void)updateAvatarImageForUser:(User *)user
                   withLocalUser:(User *)localUser;

- (void)addCaregiver:(User *)user
      withCompletion:(void (^) (BOOL success, NSError *error))completionBlock;

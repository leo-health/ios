...
- (void)setCopyFontAndColor {
    ...
    self.headerLabel.font = [UIFont leoExpandedCardHeaderFont];
    self.headerLabel.textColor = [UIColor leoGrayForTitlesAndHeadings]; //MARK: This will have to be dynamic.
}

...
+ (void)createUserWithParameters:(NSDictionary *)userParams withCompletion:(void (^)(NSDictionary *rawResults))completionBlock {
    ...
    NSString *createUserURLString = [NSString stringWithFormat:@"%@/%@",[Configuration APIEndpointWithHTTPSProtocol],APIEndpointUsers];
...
+ (void)loginUserWithParameters:(NSDictionary *)loginParams withCompletion:(void (^)(NSDictionary * rawResults))completionBlock {
    ...
    NSString *loginUserURLString = [NSString stringWithFormat:@"%@/%@",[Configuration APIEndpointWithHTTPSProtocol],APIEndpointLogin];
...
+ (void)resetPasswordWithParameters:(NSDictionary *)resetParams withCompletion:(void (^)(NSDictionary * rawResults))completionBlock {
    ...
    NSString *resetPasswordString = [NSString stringWithFormat:@"%@/%@",[Configuration APIEndpointWithHTTPSProtocol],APIEndpointResetPassword];
...
+ (void)getCardsForUser:(NSDictionary *)userParams withCompletion:(void (^)(NSDictionary *rawResults))completionBlock {
    ...
    NSString *getCardsURLString = [NSString stringWithFormat:@"%@/%@",[Configuration APIEndpointWithHTTPSProtocol],@"cards"]; //FIXME: Remove hardcoded string; replace with LEOConstant.
...
+ (void)getAllStaffForPracticeWithParameters:(NSDictionary *)practiceParams withCompletion:(void (^)(NSDictionary *rawResults))completionBlock {
    ...
    NSString *getPracticeStaffURLString = [NSString stringWithFormat:@"%@/%@/%@",[Configuration APIEndpointWithHTTPSProtocol],practiceParams[APIParamID],@"staff"]; //FIXME: Remove hardcoded string; replace with LEOConstant. This also is definitely not the right URL.
...
+ (void)getAppointmentTypesWithCompletion:(void (^)(NSDictionary *rawResults))completionBlock {
    ...
    NSString *getAppointmentTypesURLString = [NSString stringWithFormat:@"%@/%@",[Configuration APIEndpointWithHTTPSProtocol],APIEndpointAppointmentTypes]; //FIXME: Remove hardcoded string; replace with LEOConstant. This also is definitely not the right URL.
...
+ (void)getFamilyWithUserParameters:(NSDictionary *)userParams withCompletion:(void (^)(NSDictionary *rawResults))completionBlock {
    ...
    NSString *getFamilyURLString = [NSString stringWithFormat:@"%@/%@",[Configuration APIEndpointWithHTTPSProtocol],@"family"]; //FIXME: Remove hardcoded string; replace with LEOConstant. This also is definitely not the right URL.
...
+ (void)createAppointmentWithParameters:(NSDictionary *)apptParams withCompletion:(void (^)(NSDictionary *rawResults))completionBlock {
    ...
    NSString *createAppointmentURLString = [NSString stringWithFormat:@"%@/%@",[Configuration APIEndpointWithHTTPSProtocol],APIEndpointAppointments];
...
+ (void)getAppointmentsForFamilyWithParameters:(NSDictionary *)params withCompletion:(void (^)(NSDictionary  * rawResults))completionBlock {
    ...
    NSString *getAppointmentsURLString = [NSString stringWithFormat:@"%@/%@",[Configuration APIEndpointWithHTTPSProtocol],APIEndpointAppointments];
...
+ (void)getConversationsForFamilyWithParameters:(NSDictionary *)conversationParams withCompletion:(void (^)(NSDictionary  * rawResults))completionBlock {
    ...
    NSString *getConversationsURLString = [NSString stringWithFormat:@"%@/%@",[Configuration APIEndpointWithHTTPSProtocol],APIEndpointConversations];
...
+ (void)createMessageForConversation:(NSString *)conversationID withParameters:(NSDictionary *)messageParams withCompletion:(void (^)(NSDictionary *rawResults))completionBlock {
    ...
    NSString *createMessageForConversationURLString = [NSString stringWithFormat:@"%@/%@/%@/%@",[Configuration APIEndpoint],APIEndpointConversations,conversationID, APIEndpointMessages];
...
+ (void)getMessagesForConversation:(NSString *)conversationID withParameters:(NSDictionary *)messageParams withCompletion:(void (^)(NSDictionary *rawResults))completionBlock {
    ...
    NSString *getMessagesForConversationURLString = [NSString stringWithFormat:@"%@/%@/%@/%@",[Configuration APIEndpointWithHTTPSProtocol],APIEndpointConversations,conversationID, APIEndpointMessages];
